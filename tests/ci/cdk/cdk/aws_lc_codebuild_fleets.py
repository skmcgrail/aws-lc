...
class CodeBuildFleet(Construct):
    ...
    def _create_fleet(self) -> codebuild.CfnFleet:
    ...
    def _get_compute_configuration(self) -> Dict[str, any]:
        ...
        if config.compute_type:
            ...
            return {
                ...
                "overflow_behavior": codebuild.FleetOverflowBehavior.QUEUE,
            }
            ...
            return {
                ...
                "compute_type": codebuild.FleetOverflowBehavior.QUEUE,
            }
        else:
